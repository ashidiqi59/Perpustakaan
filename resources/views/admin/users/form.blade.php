                ...
                @else
                    ...
                    <div>
                        ...
                        <select name="role" id="role-select" required
                            class="w-full px-4 py-2.5 text-sm bg-slate-50/60 border border-slate-300 rounded-xl focus:bg-white focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all text-slate-800 font-medium cursor-pointer">
