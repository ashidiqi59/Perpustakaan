...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden mb-6">
        <div class="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div class="p-6 sm:p-8 bg-slate-50/60 border-b lg:border-b-0 lg:border-r border-slate-200 flex flex-col items-center text-center justify-center">
                ...
                @if($user->npm)
                    <p class="text-xs font-mono text-slate-500 bg-slate-200/70 px-2.5 py-1 rounded-md mb-3 inline-flex items-center gap-1.5">
                        <i class="fas fa-id-card text-slate-400"></i>
                        <span>NPM: {{ $user->npm }}</span>
                    </p>
                @else
                    <p class="text-xs italic text-slate-400 bg-slate-100 px-2.5 py-1 rounded-md mb-3">
                        Staf Sistem Perpustakaan
                    </p>
                @endif
            ...
            <div class="lg:col-span-2 p-6 sm:p-8 flex flex-col justify-between">
                <div>
                    <div class="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
                        <div>
                            <h3 class="text-base sm:text-lg font-bold text-slate-800">Biodata &amp; Informasi Akun</h3>
                            <p class="text-xs text-slate-500">Rincian profil terdaftar dalam sistem perpustakaan</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-sm font-semibold text-slate-800">
                                    ...
                                    @elseif($user->role === 'petugas')
                                        Scanner Barcode, Sirkulasi &amp; Validasi Buku
                                    @else
                                        Katalog, Peminjaman &amp; Barcode Mandiri
                                    @endif
                                </p>
                            </div>
                        </div>
                        ...
                        <!-- KEAMANAN PASSWORD (DIKECUALIKAN / PRIVASI) -->
                        <div class="flex items-start gap-3">
    ...
    <!-- LOANS SECTION (JIKA MEMILIKI RIWAYAT PEMINJAMAN) -->
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 overflow-hidden mb-6">
