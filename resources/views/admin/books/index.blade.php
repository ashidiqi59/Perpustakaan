            ...
            <main class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex-1 overflow-y-auto p-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
                        <form action="{{ route('admin.books.index') }}" method="GET" class="flex flex-wrap gap-4 items-end">
                            ...
                            <div class="flex gap-2">
                                ...
                                @if($search || $category)
                                    <a href="{{ route('admin.books.index') }}" class="px-4 py-2 bg-slate-500 text-white rounded-lg hover:bg-slate-600 transition-colors">
