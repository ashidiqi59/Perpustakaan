        ...
        <div class="app-wrapper flex">
            ...
            <aside id="sidebar" class="bg-slate-900 text-white flex flex-col">
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                    <a href="{{ route('petugas.dashboard') }}" class="nav-item flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-colors {{ request()->routeIs('petugas.*') ? 'bg-amber-500 text-slate-900' : 'text-slate-300 hover:bg-slate-800' }}">
